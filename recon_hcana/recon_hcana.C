...
void recon_hcana::ProductionReadTree(){
  ...
  tree->SetBranchAddress("phicmi", &phicm);  
  ...
  //ACP adding: want MandelU
  newTree->Branch("u", &u, "u/F");
...
void recon_hcana::EventLoop(){
  ...
  for (Int_t i=0;i<nentries;i++) {
    ...
    */
    ...
    //ACP adding
    //Need ui for functional forms 
    //Note ti>0 but t<0
    ui = 2*MP*MP + Mw*Mw + ti -Wi*Wi - Q2i;
